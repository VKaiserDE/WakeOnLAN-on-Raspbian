                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="UserDel">Benutzer Entfernen</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
            ...
            <div class="row content">
                    ...
                    <div class="col-sm-8 text-center"> 
                        ...
                        <div class="well align-items-center">
                            ...
                            <?php echo form_open('UserDel'); ?>

                            <?php echo form_error('DelUsername'); ?>

                                <div class="form-group row">
                                    <label for="DelUsername" class="col-sm-4 col-form-label"></label>
                                    <div class="col-sm-4">
                                        <input id="DelUsername" type="text" class="form-control" name="DelUsername" value="<?php echo set_value('DelUsername'); ?>" placeholder="Benutzername"/>
                                    </div>
                                </div>
