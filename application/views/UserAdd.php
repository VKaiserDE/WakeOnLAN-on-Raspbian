                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li class="active"><a href="UserAdd">Benutzer Hinzufügen</a></li>
                        ...
                        <div class="well align-items-center">
                            ...
                            <?php echo form_error('AddUsername'); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="Username" type="text" class="form-control" name="AddUsername" value="<?php echo set_value('AddUsername'); ?>" placeholder="Benutzername"/>
                                    </div>
                                </div>
                            ...
                            <?php echo form_error('AddPassword'); ?>
                                ...
                                <div class="form-group row">
                                    <label for="AddPassword" class="col-sm-4 col-form-label"></label>
                                    <div class="col-sm-4">
                                        <input id="AddPassword" type="password" class="form-control" name="AddPassword" value="<?php echo set_value('AddPassword'); ?>" placeholder="Passwort"/>
                                    </div>
                                </div>   

                            <?php echo form_error('AddPasswordCtrl'); ?>

                                <div class="form-group row">
                                    <label for="AddPasswordCtrl" class="col-sm-4 col-form-label"></label>
                                    <div class="col-sm-4">
                                        <input id="AddPasswordCtrl" type="password" class="form-control" name="AddPasswordCtrl" value="<?php echo set_value('AddPasswordCtrl'); ?>" placeholder="Passwort Bestätigen"/>
                                    </div>
                                </div>  
